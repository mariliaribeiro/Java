 ...
 * @author Samsung.com
 */
public class BoletoBancoDoBrasil extends BoletoBuilder{

    protected
    String pagador, sacador;
    double valor, tarifa;

    public BoletoBancoDoBrasil(String pagador, String sacador, double valor) {
    ...
    public void buildTituloDocumento(){
        boleto.tituloDocumento = "Boleto BB - Banco do Brasil";
    }
